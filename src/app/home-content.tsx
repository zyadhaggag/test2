...
export function HomeContent() {
    ...
    return (
        <div className="py-6 space-y-20 w-full px-0 sm:px-0">
            {/* Hero Slider */}
            ...
            {/* Banner Ads */}
            <section className="w-full relative h-[300px] sm:h-[400px] bg-ultra-bg-secondary overflow-hidden cursor-pointer group" onClick={() => setIsModalOpen(true)}>
                <Image src="/ads.svg" alt="إعلان" fill className="object-cover transition-transform group-hover:scale-105 duration-ultra" />
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-ultra">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10 py-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    <div className="bg-gradient-to-b from-ultra-surface to-ultra-card p-10 rounded-[32px] border border-ultra-border shadow-ultra hover:shadow-glow transition-all duration-ultra hover:-translate-y-2 group relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-ultra-silver-muted/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-ultra"></div>
                        <div className="relative w-20 h-20 mx-auto bg-ultra-bg rounded-2xl flex items-center justify-center mb-8 border border-ultra-border group-hover:border-ultra-silver-muted/30 transition-colors shadow-inner">
                            <Zap className="text-ultra-silver-bright group-hover:scale-110 transition-transform duration-ultra" size={32} />
                        </div>
                        <h3 className="relative font-bold text-2xl text-ultra-silver-bright mb-4 group-hover:text-white transition-colors">سرعة الإنجاز</h3>
                        <p className="relative text-ultra-silver-muted text-sm leading-relaxed group-hover:text-ultra-silver-bright transition-colors">تنفيذ سريع لجميع طلباتك مع الحفاظ على أعلى معايير الجودة والإتقان في كل تفصيلة.</p>
                    </div>
                    <div className="bg-gradient-to-b from-ultra-surface to-ultra-card p-10 rounded-[32px] border border-ultra-border shadow-ultra hover:shadow-glow transition-all duration-ultra hover:-translate-y-2 group relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-ultra-silver-muted/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-ultra"></div>
                        <div className="relative w-20 h-20 mx-auto bg-ultra-bg rounded-2xl flex items-center justify-center mb-8 border border-ultra-border group-hover:border-ultra-silver-muted/30 transition-colors shadow-inner">
                        ...
                        <h3 className="relative font-bold text-2xl text-ultra-silver-bright mb-4 group-hover:text-white transition-colors">جودة وضمان</h3>
                        <p className="relative text-ultra-silver-muted text-sm leading-relaxed group-hover:text-ultra-silver-bright transition-colors">نضمن لك الحصول على منتجات برمجية وتصاميم خالية من الأخطاء وذات كفاءة عالية.</p>
                    </div>
                    <div className="bg-gradient-to-b from-ultra-surface to-ultra-card p-10 rounded-[32px] border border-ultra-border shadow-ultra hover:shadow-glow transition-all duration-ultra hover:-translate-y-2 group relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-ultra-silver-muted/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-ultra"></div>
                        <div className="relative w-20 h-20 mx-auto bg-ultra-bg rounded-2xl flex items-center justify-center mb-8 border border-ultra-border group-hover:border-ultra-silver-muted/30 transition-colors shadow-inner">
                        ...
                        <h3 className="relative font-bold text-2xl text-ultra-silver-bright mb-4 group-hover:text-white transition-colors">دعم متواصل</h3>
                        <p className="relative text-ultra-silver-muted text-sm leading-relaxed group-hover:text-ultra-silver-bright transition-colors">فريق دعم فني لخدمتك في أي وقت، متواجد دائماً للإجابة على استفساراتك وحل جميع مشاكلك.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10 pb-20">
                ...
                >
                    {[
                        { name: 'أحمد عبدالله', role: 'رائد أعمال', text: 'تجربة ممتازة مع متجر ألترا، التصاميم احترافية والتسليم في الموعد المحدد.' },
                        { name: 'سارة خالد', role: 'مديرة تسويق', text: 'أفضل مكان للحصول على خدمات برمجية متكاملة. أنصح بالتعامل معهم بشدة.' },
                        { name: 'فهد المطيري', role: 'مؤسس شركة', text: 'جودة العمل والتواصل الرائع جعلت من ألترا خياري الأول في كل مشاريعي.' },
                        { name: 'يوسف العندس', role: 'صانع محتوى', text: 'شريت حساب تيك توك وتوصيل فوري وأسعار خرافية بصراحة، شكرا لثقتكم.' },
                        { name: 'نورة السالم', role: 'مستقلة', text: 'خدمات الكودينج والتطوير عندهم سريعة وما فيها أي أخطاء. فريق داعم بامتياز.' },
                        { name: 'تركي الفيصل', role: 'مدير مطعم', text: 'تصميم الهوية كامل لمطعمي كان من عندهم، شغل جبار وفخم جدا.' },
                    ].map((review, i) => (
                        <div key={i} className="min-w-[300px] sm:min-w-[360px] shrink-0 snap-start bg-ultra-surface p-8 rounded-[32px] border border-ultra-border transition-all duration-ultra hover:shadow-glow hover:border-ultra-silver-dark/30">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="relative w-14 h-14 rounded-full bg-ultra-card border border-ultra-border overflow-hidden">
                                    <Image src="/usr2.svg" alt={review.name} fill className="object-cover p-2" />
                                </div>
                                <div>
                                    <h4 className=" font-bold text-ultra-silver-bright">{review.name}</h4>
                                    <span className="text-xs text-ultra-silver-muted">{review.role}</span>
                                </div>
                            </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-[fadeIn_0.3s_ease]">
                    <div className="bg-ultra-card border border-ultra-border rounded-2xl w-full max-w-lg p-6 relative shadow-ultra">
                        <button onClick={() => setIsModalOpen(false)} className="absolute top-4 left-4 p-2 text-ultra-silver-muted hover:text-white transition-colors bg-ultra-surface rounded-full hover:bg-ultra-border">
                            <X size={20} />
                        </button>
                        ...
                        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setIsModalOpen(false); }}>
                            <div>
                                ...
                                <input type="text" required className="w-full bg-ultra-surface border border-ultra-border rounded-xl px-4 py-3 text-white focus:border-ultra-silver-dark outline-none transition-colors" placeholder="الاسم ثلاثي" />
                            </div>
                            <div>
                                <label className="block text-sm text-ultra-silver-muted mb-1 font-bold">رقم الواتساب</label>
                                <input type="tel" required className="w-full bg-ultra-surface border border-ultra-border rounded-xl px-4 py-3 text-white outline-none transition-colors text-left font-mono" dir="ltr" placeholder="+966 ..." />
                            </div>
                            <div>
    ...
    return (
        <section className="space-y-6 w-full max-w-7xl mx-auto px-4 sm:px-6 relative group">
            <div className="flex items-center justify-between w-full">
                <div>
                    <h2 className=" font-bold text-2xl sm:text-3xl text-ultra-silver-bright">{title}</h2>
                    {desc && <p className="text-ultra-silver-muted mt-2 text-sm">{desc}</p>}
                </div>
            ...
            <div className="relative w-full">
                ...
                */}
                <div
                    ...
                    className="flex w-full gap-4 py-8 overflow-x-auto snap-x snap-mandatory scroll-smooth custom-scrollbar pb-8 -mx-4 px-4 sm:mx-0 sm:px-0"
                    dir="rtl"
                >
