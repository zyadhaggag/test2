                ...
                */}
                <div className="relative w-full aspect-[2/3] overflow-hidden bg-ultra-bg-secondary flex-shrink-0">
                    <Image
                        ...
                        alt={product.name}
                        fill
                        className="object-contain p-4 transition-transform duration-ultra group-hover:scale-105"
                    />
                    {product.is_new && (
                ...
                <div className="p-4 flex flex-col flex-grow w-full space-y-3">
                    <h3 className=" font-bold text-ultra-silver-bright text-sm leading-tight line-clamp-2 min-h-[40px]">
                        {product.name}
                    </h3>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs text-ultra-silver-muted mr-1">
                            ({product.rating})
                        </span>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-ultra-surface border border-ultra-border text-ultra-silver-bright font-bold py-2 rounded-xl transition-all duration-ultra hover:bg-ultra-card hover:shadow-glow"
                    >
